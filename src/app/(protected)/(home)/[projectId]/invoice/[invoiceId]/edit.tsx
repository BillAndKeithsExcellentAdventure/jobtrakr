        ...
        {vendors && isVendorListPickerVisible && (
          ...
          >
            <OptionList
              ...
              initialSearchText={
                isQuickBooksAccessible && !invoice.vendorId ? getVendorSearchTerm(invoice.vendor) : undefined
              }
              enableSearch={
                vendors.length > 15 || (isQuickBooksAccessible && !invoice.vendorId && !!invoice.vendor)
              }
            />
          </BottomSheetContainer>
        )}
