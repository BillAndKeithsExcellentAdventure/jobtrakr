...
import { StyleSheet, View, TouchableOpacity, SafeAreaView, Text, Dimensions, Button } from 'react-native';
  ...
  const takePicture = async () => {
    ...
    try {
      ...
      if (photo) {
        ...
        if (asset) {
          const callback = global.eventEmitter.getCallback('photoCaptured');
          if (callback) {
            callback(asset);
          }
        }
