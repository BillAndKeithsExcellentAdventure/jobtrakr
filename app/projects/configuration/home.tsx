    ...
    <SafeAreaView edges={['right', 'bottom', 'left']} style={{ flex: 1 }}>
      ...
      <View style={{ flex: 1, width: '100%', paddingHorizontal: 10, backgroundColor: colors.listBackground }}>
        <ConfigurationEntry
          ...
          onPress={() => router.push('/projects/configuration/workcategory/workCategories')}
        />
        <ConfigurationEntry
          label="Vendors"
          description="Add and Edit Vendors"
          onPress={() => router.push('/projects/configuration/vendor/vendors')}
        />
        <ConfigurationEntry
          label="Project Templates"
          description="Define Project-specific Work Items"
          onPress={() => router.push('/projects/configuration/template/templates')}
        />
      </View>
    </SafeAreaView>
  );
